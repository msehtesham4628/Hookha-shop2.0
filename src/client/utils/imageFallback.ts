// Neutral fallback only. Production catalog images should come from the synced WHM catalog.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 600">
  ...
  <text x="300" y="535" text-anchor="middle" font-family="system-ui,sans-serif" font-size="16" font-weight="700" letter-spacing="3" fill="#57534e">WORLD HOOKAH MARKET</text>
  <text x="300" y="560" text-anchor="middle" font-family="system-ui,sans-serif" font-size="11" letter-spacing="2" fill="#a8a29e">IMAGE UNAVAILABLE</text>
</svg>
`)}`;

/**
 * Normalizes catalog image URLs.
 * WHM images are proxied through our API to avoid browser hotlink/CORS problems.
 */
