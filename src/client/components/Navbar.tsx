                    ...
                    <>
                      <div className="px-4 py-2 border-b border-stone-100">
                        ...
                        <div className="mt-1.5 flex items-center justify-between">
                          <span className="text-[10px] font-bold text-amber-900 bg-amber-50 border border-amber-200 px-1.5 py-0.5 rounded-xs flex items-center gap-1">
                            <Award className="w-3 h-3 text-amber-700" />
                            <span>{(user.points !== undefined ? user.points : 1000).toLocaleString()} Lounge Pts</span>
                          </span>
                          {user.role !== 'CUSTOMER' && (
                            <span className="text-[9px] font-bold bg-stone-100 text-stone-800 px-1.5 py-0.5 rounded-xs tracking-wider">
                              {user.role.replace('_', ' ')}
                            </span>
                          )}
                        </div>
