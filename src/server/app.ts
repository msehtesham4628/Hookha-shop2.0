...
app.use('/api/auth',authRoutes);app.use('/api/products',productRoutes);app.use('/api/cart',cartRoutes);app.use('/api/wishlist',wishlistRoutes);app.use('/api/orders',orderRoutes);app.use('/api/payments',orderRoutes);app.use('/api/admin',excelSyncRoutes);app.use('/api/admin',googleSheetSyncRoutes);app.use('/api/admin',adminRoutes);app.use('/api',miscRoutes);
